...
<div class="card shadow mb-4">
	<div class="card-header py-3">
		<h6 class="m-0 font-weight-bold text-primary" >영화통계</h6>
	</div>
	<div id="app" class="container-fluid" >
		<div class="col-sm-8" >
			<box-offce v-bind:boxdata="box_data" ></box-offce>
		</div>
		<div class="col-sm-4" >
			<table class="table" >
				<tr>
		...
		templage:'<table class="table table-hover" >'
					+'<thead>'
						...
						+'<tr v-for="m in boxdata" >'
							+'<td><img :src="m.poster" width="30px" height="40px" ></td>'
	...
	new Vue({
		...
		updated:function(){
			...
			eventBus.$on('showMovieEvent', function(value){
				_this.mno = value;
				axios.get('http://localhost:8080/mvc/chart/chart_detail', {
					params:{
						mno:_this.mno
					}
